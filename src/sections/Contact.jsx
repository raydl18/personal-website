  ...
  return (
    <section id="contact" className="py-24 md:py-32 bg-primary text-white relative overflow-hidden">
      ...
      <Reveal className="max-w-[1100px] mx-auto px-6 md:px-8 text-center relative z-10">
        ...
        <span className="font-inter text-[11px] font-bold tracking-[0.4em] uppercase text-white/50">
          Inquiries
        </span>
        <h2 className="font-newsreader italic font-semibold text-5xl md:text-6xl mt-8 leading-tight tracking-tight">
          Let&apos;s build together.
        </h2>
        <p className="font-newsreader text-lg md:text-xl text-slate-300 mt-8 md:mt-10 max-w-2xl mx-auto leading-relaxed">
        ...
        <div className="mt-12 md:mt-16">
          <a
            ...
            className="inline-flex items-center justify-center gap-3 px-8 md:px-10 py-5 bg-white text-primary font-inter font-bold text-lg md:text-xl rounded-sm hover:shadow-[0_20px_50px_rgba(255,255,255,0.15)] transition-all hover-lift"
          >
        ...
        <div className="mt-12 flex justify-center gap-10 text-white/60">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="font-inter text-xs font-bold tracking-widest uppercase hover:text-white transition-colors"
          >
            GitHub
          </a>
          <a
